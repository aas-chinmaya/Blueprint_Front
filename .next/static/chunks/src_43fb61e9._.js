...
"[project]/src/modules/project-management/task/components/sub-task/SubTaskList.jsx [app-client] (ecmascript)": (function(__turbopack_context__) {
...
//   >
//     <Plus className="mr-1 h-3 w-3 sm:h-4 sm:w-4" /> Create 
//   </Button>
// )}
//       </div>
//       <div className="mb-3">
...
//   const { isTeamLead } = useCurrentUser(project?.data?.teamLeadId);
//   const router = useRouter();
//   const dispatch = useDispatch();
//   // Pagination
//   const [currentPage, setCurrentPage] = useState(1);
...
//   const safeSubtasks = Array.isArray(subtasks) ? subtasks : [];
//   const totalPages = Math.ceil(safeSubtasks.length / itemsPerPage);
//   const currentSubtasks = safeSubtasks.slice(
...
//   }, [dispatch, projectId]);
//   // Progress
//   const completedCount = safeSubtasks.filter((st) => st.status === "Completed").length;
//   const progress = safeSubtasks.length > 0 ? (completedCount / safeSubtasks.length) * 100 : 0;
//   // Permissions
//   const canManageSubtasks = isTeamLead && !isTaskClosed;
//   const handleView = (subtask) => {
//     router.push(`/workspace/task/${taskId}/${subtask.subtask_id}`);
//   };
//   const handleEdit = (subtask) => {
...
//   return (
//     <section>
//       {/* Header + Create Button (Only visible to Team Lead when task is open) */}
//       <div className="flex justify-between items-center mb-4">
//         <h3 className="text-base sm:text-lg font-semibold flex items-center gap-2">
//           <ListTodo className="h-5 w-5 text-green-600" />
//           Subtasks
//         </h3>
//         {/* Show Create button ONLY if Team Lead AND task not closed */}
//         {canManageSubtasks && (
//           <Button
//             size="sm"
...
//       </div>
//       {/* Loading / Empty */}
//       {loading && <p className="text-center text-muted-foreground">Loading subtasks...</p>}
//       {!loading && safeSubtasks.length === 0 && (
...
//             <li
//               key={st.subtask_id}
//               className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 border rounded-lg bg-card hover:shadow-sm transition-shadow"
//             >
...
//                     </Button>
//                   </TooltipTrigger>
//                   <TooltipContent>View Subtask</TooltipContent>
//                 </Tooltip>
//                 {/* Edit & Delete: ONLY if canManageSubtasks */}
//                 {canManageSubtasks && (
//                   <>
//                     <Tooltip>
//                       <TooltipTrigger asChild>
...
const TaskView = ()=>{
    ...
    const handleStatusChange = async (newStatus)=>{
        ...
        if (newStatus === "Pending") {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Task reopened successfully");
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$project$2d$management$2f$task$2f$slices$2f$taskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTaskById"])(task_id));
            return;
        }
        if (newStatus === "In Progress") {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Task is now In Progress");
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$project$2d$management$2f$task$2f$slices$2f$taskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTaskById"])(task_id));
        }
    };
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                    ...
                    children: [
                        actionBtn && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: task.description.length > 600 && !showFullDesc ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                        ...
                                        children: [
                                            ...
                                            task.description.length > 600 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(TaskView, "S0rj24pkwsueHTbWhfjBMWH4aXk=", false, function() {
    return [
...
//# sourceMappingURL=src_43fb61e9._.js.map