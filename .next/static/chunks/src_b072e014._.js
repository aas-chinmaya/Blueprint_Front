...
function MomContent({ meeting, meetingId }) {
    ...
    // === State ===
    const [mode, setMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("loading"); // "loading" | "view" | "form"
    ...
    const getAttendeesArray = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MomContent.useCallback[getAttendeesArray]": ()=>{
            const our = (meeting?.ourParty || []).map({
                "MomContent.useCallback[getAttendeesArray].our": (p)=>p.name || p.email || "Unknown"
            }["MomContent.useCallback[getAttendeesArray].our"]);
            const contact = (meeting?.contactParty || []).map({
                "MomContent.useCallback[getAttendeesArray].contact": (p)=>(p.fullName !== "undefined undefined" ? p.fullName : p.email) || "Unknown"
            }["MomContent.useCallback[getAttendeesArray].contact"]);
            return [
                ...our,
                ...contact
            ].filter(Boolean);
    ...
    const checkTimeExceeded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MomContent.useCallback[checkTimeExceeded]": ()=>{
            if (!meeting?.endTime) return false;
            const end = new Date(meeting.endTime);
            const now = new Date();
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isAfter$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAfter"])(now, end);
        }
    }["MomContent.useCallback[checkTimeExceeded]"], [
        meeting
    ]);
    ...
    const handleSignatureChange = (e)=>{
        ...
        if (file && [
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Only .png, .jpg, .jpeg allowed.");
            setSignatureFile(null);
            setSignaturePreview(null);
        }
    };
    ...
    const handleSubmit = async (status)=>{
        if (!validateForm(status)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please fill all required fields.");
        }
        const formData = new FormData();
        formData.append("agenda", momForm.agenda);
        ...
        try {
            if (status === "final" && isTimeExceeded && !isEditMode) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Delay reason submitted.");
            }
            if (isEditMode && momByMeetingId) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(status === "draft" ? "MoM updated (draft)" : "MoM finalized");
            } else {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(status === "draft" ? "MoM saved (draft)" : "MoM created");
            }
            setMode("view");
            setIsEditMode(false);
            setReasonForDelay("");
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Error: ${err?.message || "Unknown error"}`);
        }
    };
    const startEdit = ()=>{
        setMode("form");
        ...
        children: [
            mode === "view" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    !momByMeetingId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex justify-end",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            className: "bg-teal-600 hover:bg-teal-700 text-white",
                    ...
                    momByMeetingId?.status === "final" && momView?.pdfUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            mode === "form" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MomContent, "CpVuJinfUkKES8+RMp+GUGanJ/s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDispatch"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/date-fns/format.js [app-client] (ecmascript) <locals>"); // PROPERLY IMPORTED
...
function MeetingController({ meetingId }) {
    ...
    const formatDate = (dateStr)=>{
        ...
        try {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(dateStr), "MMM d, yyyy");
        } catch  {
            return "Invalid Date";
        }
    };
    const formatTime = (dateStr)=>{
        if (!dateStr) return "N/A";
        try {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(dateStr), "h:mm a"); // 2:30 PM
        } catch  {
            return "Invalid Time";
        }
    };
    const formatDateTime = (dateStr)=>{
        if (!dateStr) return "N/A";
        try {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(dateStr), "MMM d, yyyy h:mm a");
        } catch  {
...
_s(MeetingController, "P0CorIwlr3Lk9MQ74Vu8QkiJ1Gs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDispatch"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"]
    ];
...
//# sourceMappingURL=src_b072e014._.js.map