...
"[project]/src/modules/marketing/components/AllContacts.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AllContacts() {
    ...
    const { contacts, status, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "AllContacts.useSelector": (state)=>state.contact
    }["AllContacts.useSelector"]);
    // States
    ...
    const statusCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AllContacts.useMemo[statusCounts]": ()=>{
            const counts = {
                all: contacts?.length || 0
            };
            statusOptions.forEach({
                "AllContacts.useMemo[statusCounts]": (status)=>{
                    if (status !== 'all') {
                        counts[status] = (contacts || []).filter({
                            "AllContacts.useMemo[statusCounts]": (c)=>c?.status === status
                        }["AllContacts.useMemo[statusCounts]"]).length;
                    }
                }
            }["AllContacts.useMemo[statusCounts]"]);
            return counts;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AllContacts.useEffect": ()=>{
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$marketing$2f$slices$2f$contactSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllContacts"])()).catch({
                "AllContacts.useEffect": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to fetch contacts')
            }["AllContacts.useEffect"]);
        }
    }["AllContacts.useEffect"], [
        dispatch
    ...
    const filteredAndSortedContacts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AllContacts.useMemo[filteredAndSortedContacts]": ()=>{
            let result = (contacts || []).filter({
                "AllContacts.useMemo[filteredAndSortedContacts].result": (c)=>!c?.isDeleted
            }["AllContacts.useMemo[filteredAndSortedContacts].result"]);
            ...
            if (searchTerm) {
                ...
                result = result.filter({
                    "AllContacts.useMemo[filteredAndSortedContacts]": (c)=>c.fullName?.toLowerCase().includes(term) || c.email?.toLowerCase().includes(term) || c.phone?.toLowerCase().includes(term) || c.inquirySource?.toLowerCase().includes(term)
                }["AllContacts.useMemo[filteredAndSortedContacts]"]);
            }
            // Status filter
            if (filterStatus !== 'all') {
                result = result.filter({
                    "AllContacts.useMemo[filteredAndSortedContacts]": (c)=>c.status === filterStatus
                }["AllContacts.useMemo[filteredAndSortedContacts]"]);
            }
            // Date range
            if (dateRange.from && dateRange.to) {
                result = result.filter({
                    "AllContacts.useMemo[filteredAndSortedContacts]": (c)=>c.createdAt ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isWithinInterval$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWithinInterval"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(c.createdAt), {
                            start: dateRange.from,
                            end: dateRange.to
                        }) : false
                }["AllContacts.useMemo[filteredAndSortedContacts]"]);
            ...
            // Sorting
            result.sort({
                "AllContacts.useMemo[filteredAndSortedContacts]": (a, b)=>{
                    const A = a[sortField] || '';
                    const B = b[sortField] || '';
    ...
    const handleSearchChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(debounce({
        "AllContacts.useCallback[handleSearchChange]": (value)=>{
            setSearchTerm(value);
            setCurrentPage(1);
        }
    }["AllContacts.useCallback[handleSearchChange]"], 300), []);
    const handleSort = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AllContacts.useCallback[handleSort]": (field)=>{
            setSortField({
                "AllContacts.useCallback[handleSort]": (prev)=>{
                    if (prev === field) {
                        setSortOrder({
                            "AllContacts.useCallback[handleSort]": (o)=>o === 'asc' ? 'desc' : 'asc'
                        }["AllContacts.useCallback[handleSort]"]);
                    } else {
                        setSortOrder('asc');
                    }
                    return field;
    ...
    const handleAddContact = (data)=>{
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$marketing$2f$slices$2f$contactSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addContact"])(data)).then((res)=>{
            if (res.meta.requestStatus === 'fulfilled') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Contact added successfully');
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$marketing$2f$slices$2f$contactSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllContacts"])());
                setIsAddModalOpen(false);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to add contact');
            }
        });
    };
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            className: "p-1",
                            children: status === 'loading' && !contacts ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FullSkeleton, {}, void 0, false, {
                                fileName: "[project]/src/modules/marketing/components/AllContacts.jsx",
                                lineNumber: 1046,
                                columnNumber: 15
...
_s(AllContacts, "KhGN4rCYuNZrWvJ5mi2Dyj6CQCc=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "AllContacts");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/(protected)/marketing/contacts/all/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$marketing$2f$components$2f$AllContacts$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/marketing/components/AllContacts.jsx [app-client] (ecmascript)");
'use client';
;
;
function Contact() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$marketing$2f$components$2f$AllContacts$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
//# sourceMappingURL=src_82c9be3c._.js.map