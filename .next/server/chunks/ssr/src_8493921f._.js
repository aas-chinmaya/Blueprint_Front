...
//     );
//   }
//   // ERROR — beautiful single UI
// if (status === "failed" || localError || !selectedMeeting) {
//   const msg =
//     localError ||
//     error ||
//     (!selectedMeeting ? "We couldn't find this meeting." : "Something went wrong.");
//   return (
...
//         className="px-6 py-2 rounded-xl bg-black text-white hover:bg-gray-800 transition-all shadow-md"
//       >
//         ← Go Back
//       </button>
//     </div>
...
//# sourceMappingURL=src_8493921f._.js.map