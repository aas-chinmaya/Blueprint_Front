...
function RecentContactsList() {
    ...
    const filteredAndSortedContacts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RecentContactsList.useMemo[filteredAndSortedContacts]": ()=>{
            ...
            if (timeFilter !== "all") {
                const now = new Date();
                const twentyFourHoursAgo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subHours$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subHours"])(now, 24);
                result = result.filter({
