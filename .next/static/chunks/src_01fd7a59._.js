...
"[project]/src/modules/project-management/task/components/EmployeeTaskList.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EmployeeTasksList = ()=>{
    ...
    const employeeTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$project$2d$management$2f$task$2f$slices$2f$taskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectAllTaskListByEmployeeId"]);
    const { loading: userLoading, employeeData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "EmployeeTasksList.useSelector": (state)=>state.user
    }["EmployeeTasksList.useSelector"]);
    const { isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "EmployeeTasksList.useSelector": (state)=>state.task
    }["EmployeeTasksList.useSelector"]);
    ...
    const [sortBy, setSortBy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("title-asc");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EmployeeTasksList.useEffect": ()=>{
            if (employeeId) {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$project$2d$management$2f$task$2f$slices$2f$taskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllTaskByEmployeeId"])(employeeId));
            }
        }
    }["EmployeeTasksList.useEffect"], [
        dispatch,
    ...
    // Process tasks
    const processedTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EmployeeTasksList.useMemo[processedTasks]": ()=>{
            return employeeTasks.map({
                "EmployeeTasksList.useMemo[processedTasks]": (task)=>({
                        ...task,
                        id: task.task_id,
                        _id: task._id,
    ...
    // Task statistics
    const taskStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EmployeeTasksList.useMemo[taskStats]": ()=>({
                total: processedTasks.length,
                planned: processedTasks.filter({
                    "EmployeeTasksList.useMemo[taskStats]": (item)=>item.status === 'Planned'
                }["EmployeeTasksList.useMemo[taskStats]"]).length,
                inProgress: processedTasks.filter({
                    "EmployeeTasksList.useMemo[taskStats]": (item)=>item.status === 'In Progress'
                }["EmployeeTasksList.useMemo[taskStats]"]).length,
                completed: processedTasks.filter({
                    "EmployeeTasksList.useMemo[taskStats]": (item)=>item.status === 'Completed'
                }["EmployeeTasksList.useMemo[taskStats]"]).length,
                highPriority: processedTasks.filter({
                    "EmployeeTasksList.useMemo[taskStats]": (item)=>item.priority === 'High'
                }["EmployeeTasksList.useMemo[taskStats]"]).length,
                mediumPriority: processedTasks.filter({
                    "EmployeeTasksList.useMemo[taskStats]": (item)=>item.priority === 'Medium'
                }["EmployeeTasksList.useMemo[taskStats]"]).length,
                lowPriority: processedTasks.filter({
                    "EmployeeTasksList.useMemo[taskStats]": (item)=>item.priority === 'Low'
                }["EmployeeTasksList.useMemo[taskStats]"]).length
            })
    }["EmployeeTasksList.useMemo[taskStats]"], [
        processedTasks
    ...
    const filteredAndSortedTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EmployeeTasksList.useMemo[filteredAndSortedTasks]": ()=>{
            let filtered = processedTasks;
            if (selectedStatus !== 'all') {
                filtered = filtered.filter({
                    "EmployeeTasksList.useMemo[filteredAndSortedTasks]": (task)=>task.status === selectedStatus
                }["EmployeeTasksList.useMemo[filteredAndSortedTasks]"]);
            }
            if (selectedPriority !== 'all') {
                filtered = filtered.filter({
                    "EmployeeTasksList.useMemo[filteredAndSortedTasks]": (task)=>task.priority === selectedPriority
                }["EmployeeTasksList.useMemo[filteredAndSortedTasks]"]);
            }
            if (searchTerm.trim() !== '') {
                const term = searchTerm.toLowerCase();
                filtered = filtered.filter({
                    "EmployeeTasksList.useMemo[filteredAndSortedTasks]": (task)=>task.title?.toLowerCase().includes(term) || task.projectName?.toLowerCase().includes(term) || task.assignedBy?.toLowerCase().includes(term) || task.id?.toString().includes(term)
                }["EmployeeTasksList.useMemo[filteredAndSortedTasks]"]);
            }
            ...
            return [
                ...
                "EmployeeTasksList.useMemo[filteredAndSortedTasks]": (a, b)=>{
                    switch(sortBy){
                        case "id-asc":
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                    ...
                    children: [
                        ...
                        isLoading && filteredAndSortedTasks.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 412,
                            columnNumber: 13
                        }, this) : filteredAndSortedTasks.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NoResults, {}, void 0, false, {
                            fileName: "[project]/src/modules/project-management/task/components/EmployeeTaskList.js",
                            lineNumber: 416,
                            columnNumber: 13
                                                ...
                                                children: paginatedTasks.map((task)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                ...
                                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formatDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDateUTC"])(task.deadline) || 'No Deadline'
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/modules/project-management/task/components/EmployeeTaskList.js",
                                                                lineNumber: 448,
                                                                columnNumber: 25
...
_s(EmployeeTasksList, "HEBaQMhfMwvwBmH5cYbGlGSw+xo=", false, function() {
    return [
...
_c = EmployeeTasksList;
const __TURBOPACK__default__export__ = EmployeeTasksList;
var _c;
__turbopack_context__.k.register(_c, "EmployeeTasksList");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/(protected)/workspace/task/my-tasks/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$project$2d$management$2f$task$2f$components$2f$EmployeeTaskList$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/project-management/task/components/EmployeeTaskList.js [app-client] (ecmascript)");
...
function AllTaskListByRole() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$project$2d$management$2f$task$2f$components$2f$EmployeeTaskList$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(AllTaskListByRole, "n8suykeOKz3f7XVLzyaioRvd+hI=", false, function() {
    return [
...
_c = AllTaskListByRole;
var _c;
__turbopack_context__.k.register(_c, "AllTaskListByRole");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_01fd7a59._.js.map